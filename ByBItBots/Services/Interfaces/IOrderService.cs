...
namespace ByBItBots.Services.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<string> AmendOrderAsync(Category category, string symbol, string orderId, string price);
        Task<string> AmendOrderAsync(Category category, string symbol, string orderId, string quantity, string price);
    }
}
